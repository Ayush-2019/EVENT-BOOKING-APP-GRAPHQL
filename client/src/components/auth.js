    ...
    submitForm = (event) => {
        ...
        .then(resdata => {
            ...
            if(resdata.data.signin.token){
                localStorage.setItem("token",resdata.data.signin.token);
                localStorage.setItem("userID",resdata.data.signin.userID);
                localStorage.setItem("tokenexpire",resdata.data.signin.tokenexpire);
